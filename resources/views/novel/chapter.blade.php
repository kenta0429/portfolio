...
@section('content')
  ...
  <div class="cover novels section">
    <div class="content-main">
      ...
      <h4>あらすじ</h4>
      <div class="abstract">
        　お前の家ティレア家は、財の力で爵位を得た新興貴族だ！　そんな歴史も品もない家に生まれた女が、名家に生まれた俺に相応しいはずがない！　俺はどうして気付かなかったんだ――。<br />
        <br />
        　婚約中に心変わりをされたクレランズ伯爵家のジェラール様は、沢山の暴言を口にしたあと、一方的に婚約の解消を宣言しました。<br />
        　そうしてジェラール様はわたしのもとを去り、曰く『お前と違って貴族然とした女性』であり『気品溢れる女性』な方と新たに婚約を結ばれたのですが――<br />
        <br />
